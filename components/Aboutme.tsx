  ...
  return (
    <section id="aboutme" className="h-full xl:h-[140vh] bg-[#121212] pb-[3rem] pt-[4rem] md:pt-[6rem]">
      <div className="container mx-auto">
        <h1 className="text-[20px] font-bold uppercase text-[#EFC40F] relative mx-[1.4rem] md:mx-0 lg:mx-0 xl:mx-0">About Me</h1>
        <div className='grid grid-cols-1 md:grid-cols-2 w-[90%] xl:w-full mx-auto gap-[3rem]'>
          <div>
